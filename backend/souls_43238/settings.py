"""
Django settings for souls_43238 project.
...
WSGI_APPLICATION = 'souls_43238.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "souls_43238 API",
    "DESCRIPTION": "API documentation for souls_43238 App",
    "VERSION": "v1",
}
